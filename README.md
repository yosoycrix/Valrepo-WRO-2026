...
- [Índice](#índice)
  ...
  - [1. Nuestro Equipo](#1-nuestro-equipo)
    ...
    - [1.3 Nuestro Objetivo](#13-nuestro-objetivo)
      - ["Diseñar, Construir y Programar"](#diseñar-construir-y-programar)
  ...
  - [2.2 Apartado Mecanico](#22-apartado-mecanico)
    ...
    - [Soluciones de Ingeniería](#soluciones-de-ingeniería)
  ...
  - [Diferencias mas importantes entre transmisión 4x4 y 4x2](#diferencias-mas-importantes-entre-transmisión-4x4-y-4x2)
    - [2.6.2 **Servomotor INJORA 180°**](#262-servomotor-injora-180)
    - [2.6.3 **Motor Hytech GA37-520**](#263-motor-hytech-ga37-520)
    - [Calculo de la Reduccion total](#calculo-de-la-reduccion-total)
      - [¿Por qué es importante la reducción?](#por-qué-es-importante-la-reducción)
    - [Razones para elegir este motor y sistema de reducción](#razones-para-elegir-este-motor-y-sistema-de-reducción)
  ...
  - [3. Apartado Electronico](#3-apartado-electronico)
    ...
    - [3.1.3 **Motor Driver**](#313-motor-driver)
      - [**Partes clave del módulo L298N:**](#partes-clave-del-módulo-l298n)
      - [**¿Cómo controla un motor DC?**](#cómo-controla-un-motor-dc)
    ...
    - [Configuración para Entrenamiento de Detección de Colores](#configuración-para-entrenamiento-de-detección-de-colores)
...
<table>
  <tr>
    ...
    <td align="center">
      ...
      <img src="./v-photos/izquierda.jpeg" width="100%">
    </td>
  </tr>
  <tr>
    <td align="center">
  ...
  <img src="./v-photos/superior.jpeg" width="80%">
    ...
    <td align="center">
      <b>Inferior</b><br>
      <img src="./v-photos/inferior.jpeg" width="100%">
    </td>
  </tr>
</table>
